...
containsEmail('n.stuivenberg@novi.nl')
...
function correctEmailAdress (emailList, wrongEmail, correctEmail) {
    // Find index of wrong email adress
    let objIndex = emailList.indexOf(wrongEmail);
    // Replace object with correct email adress
    emailList[objIndex] = correctEmail;
}

correctEmailAdress(emailadresses, 'm.vandergeest@novi-education.nl', 'm.vandergeest@novi.nl')
